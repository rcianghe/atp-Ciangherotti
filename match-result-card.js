...
function ensureMatchResultCardStyles(){
  ...
  var css = ''
    ...
    + '.mrc-centro-txt{font-size:.68rem;text-transform:uppercase;letter-spacing:1px}'
    + '.mrc-centro-live{font-size:.68rem;text-transform:uppercase;letter-spacing:1px;color:var(--mrc-ro)}'
